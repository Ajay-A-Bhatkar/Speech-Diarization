# Speaker Diarization & Identification Pipeline
# --------------------------------------------
...
# --------------------------------------------
# Utility: Converts all .wav files in root_dir to 16kHz mono (in-place)
# --------------------------------------------
...
# --------------------------------------------
# Training: Extract embeddings & train speaker classifier
# --------------------------------------------

def train_speaker_classifier(dataset_path, segment_duration=3):
        ...
        for file in os.listdir(speaker_path):
            ...
            try:
                ...
                for i in range(num_segments):
                    ...
                    end = int((i + 1) * segment_duration * fs)
...
# --------------------------------------------
# Inference Pipeline: Full workflow for diarization & speaker labeling
# --------------------------------------------

def run_inference(audio_file, hf_token):
    device = "cuda" if torch.cuda.is_available() else "cpu"
    compute_type = "float16" if device == "cuda" else "int8"
    # Step 1: Audio preprocessing
    print("Preprocessing audio with FFmpeg...")
    cleaned_audio = "cleaned_audio.wav"
    ffmpeg.input(audio_file).output(cleaned_audio, ac=1, ar=16000, af='loudnorm', y=None).run(quiet=True)
    ...
    transcription = model.transcribe(cleaned_audio, batch_size=8, language=detected_lang)
    # Step 5: Alignment
    ...
    # Step 7: Speaker ID Classification
    ...
    # Step 8: Merge transcript & speakers
    ...
    # Step 9: Format and export to Excel
    gen = gender.Detector()
    rows = []
...
if __name__ == "__main__":
    ...
    train_speaker_classifier("sample_data")
    # Set your HuggingFace token and uploaded test file
    run_inference("wav_audio_file", hf_token="YOUR_HF_TOKEN")
